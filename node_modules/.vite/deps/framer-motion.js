...
function usePresence(subscribe = true) {
  ...
  const id3 = (0, import_react3.useId)();
  (0, import_react3.useEffect)(() => {
    if (subscribe) {
      return register(id3);
    }
  }, [subscribe]);
  const safeToRemove = (0, import_react3.useCallback)(() => subscribe && onExitComplete && onExitComplete(id3), [id3, onExitComplete, subscribe]);
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  const exitingComponents = (0, import_react5.useRef)(/* @__PURE__ */ new Set());
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  const parentConfig = (0, import_react11.useContext)(MotionConfigContext);
...
function useAnimate() {
  ...
  const animate2 = (0, import_react22.useMemo)(() => createScopedAnimate({ scope, reduceMotion }), [scope, reduceMotion]);
  useUnmountEffect(() => {
...
function useCycle(...items) {
  const index = (0, import_react26.useRef)(0);
  const [item, setItem] = (0, import_react26.useState)(items[index.current]);
  const runCycle = (0, import_react26.useCallback)(
    (next) => {
...
function useInView(ref, { root, margin, amount, once = false, initial = false } = {}) {
  const [isInView, setInView] = (0, import_react27.useState)(initial);
...
function useInstantTransition() {
  ...
  const unlockOnFrameRef = (0, import_react28.useRef)(-1);
...
function usePageInView() {
  const [isInView, setIsInView] = (0, import_react29.useState)(true);
...
function useAnimatedState(initialState) {
  const [animationState, setAnimationState] = (0, import_react30.useState)(initialState);
...
var AnimateSharedLayout = ({ children }) => {
  ...
  return (0, import_jsx_runtime8.jsx)(LayoutGroup, { id: useConstant(() => `asl-${id2++}`), children });
};
...
function useInvertedScale(scale2) {
  ...
  const { visualElement } = (0, import_react31.useContext)(MotionContext);
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  return (0, import_jsx_runtime9.jsx)(Component3, { ...props, style: groupStyle, ref: setRef2, ignoreStrict: true, children: (0, import_jsx_runtime9.jsx)(ReorderContext.Provider, { value: context, children }) });
}
